    ...
    <main>
        ...
        <section class="habitats-gallery">
            ...
            <div class="habitat-card">
                <img src="assets/images/savane.jpg" alt="Savane" class="habitat-image">
                <h3>Savane</h3>
            ...
            <!-- Jungle -->
            <div class="habitat-card">
                <img src="assets/images/jungle.jpg" alt="Jungle" class="habitat-image">
                <h3>Jungle</h3>
            ...
            <!-- Arctique -->
            <div class="habitat-card">
                <img src="assets/images/polaire.jpg" alt="Arctique" class="habitat-image">
                <h3>Arctique</h3>
